  ...
  return (
    <>
      <div className="relative group group/card">
        <div onClick={handleClick} className={mergeTW(`flex items-start gap-x-4 relative py-3 rounded-2xl cursor-pointer ${className}`)}>
          {children}
        </div>
        <div className="absolute -z-10 rounded-2xl group-hover:bg-slate-700/60 opacity-0 group-hover:opacity-100 duration-150 sm:-inset-3"></div>
      </div>
